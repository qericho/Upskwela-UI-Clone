...
export const Hero = () => {
    return (
        <section>
            <div className="flex flex-col justify-center items-center space-y-5 h-150">
                {/* Tagline */}
                <div className="space-x-2 relative bg-[hsl(207,83%,49%,0.05)] border border-[#ddd] text-[hsl(207,83%,49%)] px-5 py-3 text-sm font-medium rounded-full">
                    <span className="font-semibold text-[12px] text-[hsl(202,50%,40%)] relative top-[5px]">PH</span>
                ...
                {/* Tagline 2*/}
                <div className="space-x-2 relative bg-[hsl(207,83%,49%,0.05)] flex items-center 
                 border border-[#ddd] text-[rgb(22,163,74)] px-5 py-3 text-sm font-bold rounded-full">
